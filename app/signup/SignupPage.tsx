...
import { Button, Input, Label, Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle, Checkbox } from '@bfeai/ui';
...
export default function SignupPageClient() {
  ...
  return (
    <>
      ...
      <div className="absolute top-20 left-20 w-96 h-96 bg-accent/5 rounded-full blur-3xl pointer-events-none animate-pulse-ring" />
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-primary/5 rounded-full blur-3xl pointer-events-none animate-pulse-ring" style={{ animationDelay: '1s' }} />
      ...
      <Card className="w-full max-w-md relative animate-scale-in backdrop-blur-sm bg-background/95">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardDescription className="text-base">
            Join BFEAI and unlock powerful marketing tools
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
            ...
            <div className="space-y-3 animate-fade-in animate-delay-200">
              ...
              {/* Password strength indicator with premium styling */}
              {password && (
                <div className="space-y-2 animate-fade-in">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-700 dark:text-gray-300 font-medium">Password strength:</span>
            ...
            <div className="animate-fade-in animate-delay-500">
              <div className="flex items-start space-x-3 group">
                ...
                <label
                  ...
                  className="text-sm leading-relaxed text-gray-700 dark:text-gray-300 cursor-pointer group-hover:text-foreground transition-colors duration-normal"
                >
                  I confirm that I am at least 18 years old.
                </label>
              </div>
              {errors.ageConfirmation && (
                <p className="text-sm text-error flex items-center gap-1 mt-2 animate-fade-in" role="alert">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                  </svg>
            ...
            <div className="animate-fade-in animate-delay-500">
              <div className="flex items-start space-x-3 group">
                ...
                >
                  I agree to the{' '}
                  <Link href="/terms" className="text-primary hover:text-primary-hover font-semibold underline underline-offset-2 transition-colors duration-normal">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-primary hover:text-primary-hover font-semibold underline underline-offset-2 transition-colors duration-normal">
                    Privacy Policy
                  </Link>
                </label>
              </div>
            ...
            <div className="relative animate-fade-in animate-delay-500">
              ...
              <div className="relative flex justify-center text-sm font-semibold uppercase tracking-wider">
                <span className="bg-background px-4 text-gray-700 dark:text-gray-300">Or sign up with</span>
              </div>
            </div>
            ...
            {RECAPTCHA_SITE_KEY && (
              <p className="text-xs text-gray-700 dark:text-gray-300 text-center animate-fade-in animate-delay-500">
